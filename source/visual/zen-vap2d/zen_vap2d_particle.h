...
namespace Zen { namespace Vap2d {
	...
	protected: // override
		virtual void initDots() = 0;
		virtual void updateDots(float) = 0;
	...
	protected:
		virtual void initDots() override;
		virtual void updateDots(float) override;
